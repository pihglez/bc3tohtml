...
public class SystemProperties {
    ...
    public String toConsoleString(boolean conVariablesEntorno) {
        ...
        sb.append("Arquitectura (Java VM):       ");    sb.append(oSArch);          sb.append("\n");
    ...
    /**
     * Método que devuelve la carpeta raíz del usuario
     * @return <code>String</code> la carpeta raíz del usuario
     */
     ...
     * @return <code>String</code> el nombre del usuario
     */
    ...
    /**
     * Método que devuelve el nombre del sistema operativo
     * @return <code>String</code> el nombre del sistema operativo
     */
    ...
    /**
     * Método que devuelve el separador de ruta del sistema operativo en el que
     * corre la máquina virtual
     * @return <code>String</code> el separador de ruta del sistema
     */
